...
import { NIGHT_ACTION_ORDER, ROLES_BY_PLAYER_COUNT } from '../constants';
...
const LocalGameContainer: React.FC<LocalGameContainerProps> = ({ playerNames, onGoToHome }) => {
    ...
    useEffect(() => {
        const roles = ROLES_BY_PLAYER_COUNT[playerNames.length] || [];
